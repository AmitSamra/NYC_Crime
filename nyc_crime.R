...
df$OFNS_DESC[df$OFNS_DESC %in% THEFT] = "THEFT_FRAUD"

# DRUGS
DRUGS = c("DANGEROUS DRUGS")
df$OFNS_DESC[df$OFNS_DESC %in% "DANGEROUS DRUGS"] = "DRUGS"

# WEAPONS
WEAPONS = c("DANGEROUS WEAPONS","UNLAWFUL POSS. WEAP. ON SCHOOL" )
df$OFNS_DESC[df$OFNS_DESC %in% WEAPONS] = "WEAPONS"
